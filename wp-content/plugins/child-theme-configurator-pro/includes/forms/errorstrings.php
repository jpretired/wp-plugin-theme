...
$errorstrings = array(
    ...
    '29'  => __( 'Invalid theme settings archive.', 'child-theme-configurator' ),
    '30'  => __( 'Could not export settings file.', 'child-theme-configurator' ),
    '31'  => __( 'Could not create new file.', 'child-theme-configurator' ),
);
