...
<div id="query_selector_options_panel" 
        class="ctc-option-panel <?php $this->configured() ? '' : 'ctc-disable'; echo 'query_selector_options' == $active_tab ? ' ctc-option-panel-active' : ''; ?>">
  ...
  <form id="ctc_query_selector_form" method="post" action="?page=<?php echo $ctcpage; ?>">
    ...
    <div class="ctc-input-row clearfix" id="input_row_query">
      ...
      <div class="ctc-input-cell">
        <div class="ui-widget">
          <input id="ctc_sel_ovrd_query" type="text" />
        </div>
      </div>
    </div>
    <div class="ctc-input-row clearfix" id="input_row_selector">
      ...
      <div class="ctc-input-cell">
        <div class="ui-widget">
          <input id="ctc_sel_ovrd_selector" type="text" />
