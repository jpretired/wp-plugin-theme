 ...
 * Description:       Tento plugin může sloužit jako vzorový při vývoji vlastního pluginu. Head section cleanup and many usual custom settings used on every website setup as images settings and sizes, privacy, and basic admin customizations.
 * Version:           2.2.1
